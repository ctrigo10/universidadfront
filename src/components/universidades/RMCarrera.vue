            ...
            <v-card-text >
              <v-row>
                <v-col cols="12" sm="6" ma-1>
                  <v-text-field v-model="resolucion.numero" label="Número" placeholder="" filled></v-text-field>
                </v-col>
                <v-col cols="12" sm="6">
              ...
              <v-row>
                <v-col cols="12" sm="6">
                  <v-text-field v-model="resolucion.tiempo_estudio" label="Tiempo de Estudio" placeholder="" filled></v-text-field>
                </v-col>
                <v-col cols="12" sm="6">
...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: 'Régimen de Estudio', value: 'ttec_regimen_estudio_tipo.regimen_estudio'},
