<template>
  <div>
    <v-container grid-list-xl fluid>
      <header-title title="Aptitud Espacial"></header-title>
      <v-row class="mb-6">
        <v-col cols="12" sm="12">
          <v-card>
            <!-- <v-card-title>Formulario de evaluación</v-card-title>
          <v-divider></v-divider> -->
            <v-card-text>
              ...
              <div v-if="estado == 'preguntas'">
                <p>
                  Esta prueba consta de 60 problemas. En cada uno se presenta un
                  modelo o patrón que es el desarrollo en superficie de una
                  figura de tres dimensiones. Fíjate en los siguientes ejemplos
                  para que aprendas como contestar:
    ...
    <v-dialog v-model="edialog" scrollable width="500">
      <v-card>
        <v-card-text>
          <p class="pt-4">
            <b>Ejemplo 1.</b> ¿Cuál de estas figuras, A, B, C o D, puede
            construirse a partir del modelo expuesto como problema?
            Evidentemente sólo la C, porque las figuras son de forma y tamaño
            diferentes. Compruébelo.
          </p>
          <img :src="`${server}images/preguntas/imagen4e1.png`" width="100%" />
          <p class="pt-4">
            <b>Ejemplo 2.</b> El modelo puede doblarse formando una caja. Las
            dos caras mayores y una de las pequeñas deberán ser oscuras. La
            figura que resulta ha de tener estas tres caras oscuras aunque
            alguna no aparezca a la vista debido a la colocación de la caja.
          </p>
          <img :src="`${server}images/preguntas/imagen4e2.png`" width="100%" />
          <p>Observe: Las cuatro figuras son correctas en cuanto a la forma; pero las caras que se ven son diferentes. Sólo una de las figuras puede construirse a partir del modelo. Fíjese en las cuatro posibilidades de elección:
            <ul>
              <li>La figura A está mal; tiene un lateral oscuro y la superficie superior blanca; en el modelo los laterales son blancos y las dos superficies mayores oscuras.</li>
              <li>La figura B es igualmente incorrecta porque la superficie superior debería ser oscura.</li>
              <li>La figura C es igualmente incorrecta porque tiene oscuro uno de los laterales a diferencia del modelo.</li>
              <li>La figura D está bien; todas las caras que aparecen a la vista concuerdan con las del modelo.</li>
            </ul>
            </p>
        </v-card-text>
        <v-divider></v-divider>
